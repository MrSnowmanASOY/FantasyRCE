...
clear @s minecraft:elytra[custom_name='[{"color":"#fa9bab","text":"Harpy Wings"}]',lore=['[{"color":"red","text":"You are nothing without these wings..."}]'],rarity=epic,enchantment_glint_override=false,enchantments={show_in_tooltip:false,levels:{mending:1,unbreaking:3,binding_curse:10,vanishing_curse:1}}]