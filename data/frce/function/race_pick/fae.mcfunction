...
attribute @s minecraft:block_break_speed modifier add frce:race.fae.block.break.speed -0.2 add_multiplied_base
...
attribute @s minecraft:attack_damage modifier add frce:race.fae.attack -0.1 add_multiplied_base
